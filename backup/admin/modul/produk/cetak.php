<html>
<head>
<title>Laporan Data Keuangan PRODUK</title>
<style>
#tabel
{
font-size:15px;
...
$sql_limit = "select * from tb_produk,tbl_trans_deposit,tbl_tarif where tb_produk.id_member = tbl_trans_deposit.id_member and tbl_trans_deposit.kode_tarif = tbl_tarif.kode_tarif and (tanggal_transaksi between '$_POST[dari]' and '$_POST[sampai]') and tbl_trans_deposit.status_setujukonfirmasi = 'Y' order by tbl_trans_deposit.id_transaksi DESC";
