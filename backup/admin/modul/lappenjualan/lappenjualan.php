...
switch ($_GET['aksi'])
{
    case "tampil":
        ...
        echo "<script>
        function popup(form) {
            window.open('', 'penjualan', 'menubar=yes,scrollbars=yes,resizable=yes,width=800,height=400,top=50,left=200');
        ...
        <form id="contactform" class="rounded" action="modul/lappenjualan/cetak.php" onsubmit="popup(this);" target="_blank" method="post" enctype="multipart/form-data">';
        echo '<div id="papanpanel2">
            <h3>LAPORAN DATA PENJUALAN PRODUK</h3>
            </div>  ';
        ?>
