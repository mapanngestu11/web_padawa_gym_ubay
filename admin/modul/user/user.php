...
case "tampil";
echo '
<a href="index.php?modul=user&aksi=tambahuser" class="button">Tambah User Baru</a></br></br>
		<table id="datatables" class="display">
                ...
                <tbody>';
					          ...
					          $sql = mysqli_query($conn,"SELECT * FROM tbl_login ORDER BY user");
					          $no = 1;
                    while ($r = mysqli_fetch_array($sql)) {
                      echo "<tr>
                            ...
                            <td>";
							if (file_exists("images/user/$r[user].jpg")) {
echo "<image width='50px' height='50' src='images/user/resize.php?src=$r[user].jpg&scale=200&q=100'/>";
}else{
echo "<image width='50px' height='50' src='images/user/def.png'/>";
}
							echo"</td>
							<td><a href='?modul=user&aksi=edituser&id=".$r['user']."'>Ubah</td>
<td><a onclick=\"return confirm('Anda Yakin Menghapus Data Ini?')\" href='?modul=user&aksi=hapus&id=".$r['user']."'>Hapus</td>
                            </tr>";
