...
<body>
	...
	$akhir = $_POST['sampai'];
	// die();
	// $sql_limit = "select * from tbl_member where tanggal_daftar between $_POST[dari] 00:00:00 and $_POST[sampai] 00:00:00 order by id_member DESC";

	$sql_limit = "select * from tbl_member where tanggal_daftar between '$awal 00:00:00' and '$akhir 00:00:00' order by id_member DESC";
